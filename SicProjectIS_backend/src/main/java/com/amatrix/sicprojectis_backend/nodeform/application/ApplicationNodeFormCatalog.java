...
public final class ApplicationNodeFormCatalog {
    ...
    public static List<NodeFormDefinition> definitions() {
        return List.of(
                ...
                form("SCIENCE_EXPERT_REVIEW_FORM", "ScienceExpertReviewTask", "APPLICATION_SCIENCE_EXPERT_REVIEWING", "科技处专家评审", NodeFormDataKind.EXPERT_REVIEW, NodeFormWriteMode.HISTORY_RECORD),

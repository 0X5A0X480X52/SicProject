...
public final class AcceptanceNodeFormCatalog {
    ...
    public static List<NodeFormDefinition> definitions() {
        return List.of(
                ...
                form("EXPERT_ACCEPTANCE_ASSIGN_FORM", "ExpertAssignTask", "ACCEPTANCE_EXPERT_ASSIGNING", "分配评审专家", NodeFormDataKind.EXPERT_REVIEW, NodeFormWriteMode.HISTORY_RECORD),
                form("EXPERT_ACCEPTANCE_REVIEW_FORM", "ExpertReviewTask", "ACCEPTANCE_EXPERT_REVIEWING", "评审专家审核提交", NodeFormDataKind.EXPERT_REVIEW, NodeFormWriteMode.HISTORY_RECORD),
                form("EXPERT_ACCEPTANCE_REVIEW_SUMMARY_FORM", "ExpertSummaryTask", "ACCEPTANCE_EXPERT_SUMMARIZING", "汇总提交专家评审结果", NodeFormDataKind.EXPERT_REVIEW, NodeFormWriteMode.HISTORY_RECORD),
